        ...
        public GameObject GetGameObject(string type, float width, float height, float fromTop, float fromLeft, string colour = "Green")
        {
            ...
            switch (type)
            {
                case "AA_Infantry":     // Anti-Air Infantry
                    ...
                    unit = new Unit(width, height, fromTop, fromLeft, "Sprites/Units/Icons/Infantry/" + colour + "_AA_Infantry.gif", rangeBehavior, attackBehavior, defenceBehavior, tileBehavior, EUnitType.Infantry);
                    break;
                ...
                case "AV_Infantry":     // Anti-Vehicle Infantry
                    ...
                    // Create the Unit with the created behaviors
                    unit = new Unit(width, height, fromTop, fromLeft, "Sprites/Units/Icons/Infantry/" + colour + "_AV_Infantry.gif", rangeBehavior, attackBehavior, defenceBehavior, tileBehavior, EUnitType.Infantry);
                    break;
                ...
                case "AI_Infantry":     // Anti-Infantry Infantry
                    ...
                    // Create the Unit with the created behaviors
                    unit = new Unit(width, height, fromTop, fromLeft, "Sprites/Units/Icons/Infantry/" + colour + "_AI_Infantry.gif", rangeBehavior, attackBehavior, defenceBehavior, tileBehavior, EUnitType.Infantry);
                    break;
                ...
                case "AI_Vehicle":          // Anti_Infantry Vehicle
                    ...
                    // Create the Unit with the created behaviors
                    unit = new Unit(width, height, fromTop, fromLeft, "Sprites/Units/Icons/Vehicle/" + colour + "_AI_Vehicle.gif", rangeBehavior, attackBehavior, defenceBehavior, tileBehavior, EUnitType.Vehicle);
                    break;
                ...
                case "AV_Vehicle":          // Anti-Vehicle Vehicle
                    ...
                    // Create the Unit with the created behaviors
                    unit = new Unit(width, height, fromTop, fromLeft, "Sprites/Units/Icons/Vehicle/" + colour + "_AV_Vehicle.gif", rangeBehavior, attackBehavior, defenceBehavior, tileBehavior, EUnitType.Vehicle);
                    break;
                ...
                case "AA_Vehicle":          // Anti-Air Vehicle
                    ...
                    // Create the Unit with the created behaviors
                    unit = new Unit(width, height, fromTop, fromLeft, "Sprites/Units/Icons/Vehicle/" + colour + "_AA_Vehicle.gif", rangeBehavior, attackBehavior, defenceBehavior, tileBehavior, EUnitType.Vehicle);
                    break;
                ...
                case "AI_Air":              // Anti_Infantry Air
                    ...
                    // Create the Unit with the created behaviors
                    unit = new Unit(width, height, fromTop, fromLeft, "Sprites/Units/Icons/Air/" + colour + "_AI_Air.gif", rangeBehavior, attackBehavior, defenceBehavior, tileBehavior, EUnitType.Air);
                    break;
                ...
                case "AV_Air":              // Anti-Vehicle Air
                    ...
                    // Create the Unit with the created behaviors
                    unit = new Unit(width, height, fromTop, fromLeft, "Sprites/Units/Icons/Air/" + colour + "_AV_Air.gif", rangeBehavior, attackBehavior, defenceBehavior, tileBehavior, EUnitType.Air);
                    break;
                ...
                case "AA_Air":              // Anti-Air Air
                    ...
                    // Create the Unit with the created behaviors
                    unit = new Unit(width, height, fromTop, fromLeft, "Sprites/Units/Icons/Air/" + colour + "_AA_Air.gif", rangeBehavior, attackBehavior, defenceBehavior, tileBehavior, EUnitType.Air);
                    break;
            }
